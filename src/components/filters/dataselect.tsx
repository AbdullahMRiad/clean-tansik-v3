...
function DataSelector() {
    ...
    useEffect(() => {
        if (gender === "boys") {
            switch (year) {
                case 2019: setData(_2019b as College[]); break;
                case 2020: setData(_2020b as College[]); break;
                case 2021: setData(_2021b as College[]); break;
                case 2022: setData(_2022b as College[]); break;
                case 2023: setData(_2023b as College[]); break;
                case 2024: setData(_2024b as College[]); break;
                case 2025: setData(_2025b as College[]); break;
                default: setData([]); break;
            }
        } else if (gender === "girls") {
            switch (year) {
                case 2019: setData(_2019g as College[]); break;
                case 2020: setData(_2020g as College[]); break;
                case 2021: setData(_2021g as College[]); break;
                case 2022: setData(_2022g as College[]); break;
                case 2023: setData(_2023g as College[]); break;
                case 2024: setData(_2024g as College[]); break;
                case 2025: setData(_2025g as College[]); break;
                default: setData([]); break;
            }
        }
    }, [year, gender, setData])
    ...
    return(
        <div id="dataselector-container" className="panel">
            ...
            <div id="year-selector" className="flex justify-center">
                ...
                <span className="h-min self-center mx-8 text-lg">{year}</span>
                <button
                    className="button h-12 w-12"
                    onClick={() => {
                        if (year > 2019) {
